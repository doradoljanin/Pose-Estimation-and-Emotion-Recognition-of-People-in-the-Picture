...
def poseDetection(path):
    ...
    def detectKeypoints(probMap, threshold=0.1):
    ...
    def detectJointConnections(output):
        valid_pairs = []
        invalid_pairs = []
        n_interp_samples = 10
        paf_score_th = 0.1
    ...
    def assignJoinsToPerson(valid_pairs, invalid_pairs):
    ...
    for part in range(nPoints):
        ...
        keypoints = detectKeypoints(probMap, threshold)
    ...
    valid_pairs, invalid_pairs = detectJointConnections(output)
    personwiseKeypoints = assignJoinsToPerson(valid_pairs, invalid_pairs)
